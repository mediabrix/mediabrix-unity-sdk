...
extern Il2CppCodeGenString* _stringLiteral2914064246;
extern Il2CppCodeGenString* _stringLiteral145572359;
extern Il2CppCodeGenString* _stringLiteral221407536;
...
extern "C"  void Main__ctor_m2928940258 (Main_t2390489 * __this, const MethodInfo* method)
{
	...
	{
		__this->set_ViewButton_7(_stringLiteral2914064246);
		__this->set_FlexButton_8(_stringLiteral145572359);
		__this->set_RewardButton_9(_stringLiteral221407536);
...
extern "C"  void Main_OnGUI_m2424338908 (Main_t2390489 * __this, const MethodInfo* method)
{
	...
	}
	{
		...
		MediabrixPlugin_Show_m1879219190(NULL /*static, unused*/, _stringLiteral2914064246, /*hidden argument*/NULL);
		goto IL_0098;
	}
...
IL_0069:
	...
	}
	{
		...
		MediabrixPlugin_Load_m318050794(NULL /*static, unused*/, _stringLiteral2914064246, (Dictionary_2_t2606186806 *)NULL, /*hidden argument*/NULL);
		goto IL_0098;
	}
...
IL_0098:
	...
	{
		MonoBehaviour_print_m1497342762(NULL /*static, unused*/, _stringLiteral637150375, /*hidden argument*/NULL);
		MediabrixPlugin_Show_m1879219190(NULL /*static, unused*/, _stringLiteral145572359, /*hidden argument*/NULL);
		goto IL_011b;
	}
...
IL_00ec:
	...
	{
		MonoBehaviour_print_m1497342762(NULL /*static, unused*/, _stringLiteral637901424, /*hidden argument*/NULL);
		MediabrixPlugin_Load_m318050794(NULL /*static, unused*/, _stringLiteral145572359, (Dictionary_2_t2606186806 *)NULL, /*hidden argument*/NULL);
		goto IL_011b;
	}
...
IL_011b:
	...
	{
		MonoBehaviour_print_m1497342762(NULL /*static, unused*/, _stringLiteral637150375, /*hidden argument*/NULL);
		MediabrixPlugin_Show_m1879219190(NULL /*static, unused*/, _stringLiteral221407536, /*hidden argument*/NULL);
		goto IL_019e;
	}
...
IL_016f:
	...
	{
		MonoBehaviour_print_m1497342762(NULL /*static, unused*/, _stringLiteral637901424, /*hidden argument*/NULL);
		MediabrixPlugin_Load_m318050794(NULL /*static, unused*/, _stringLiteral221407536, (Dictionary_2_t2606186806 *)NULL, /*hidden argument*/NULL);
		goto IL_019e;
	}
...
extern "C"  void Main_OnAdUnavailable_m2404187508 (Main_t2390489 * __this, String_t* ___target, const MethodInfo* method)
{
	...
	}
	{
		...
		NullCheck(L_2);
		bool L_3 = String_Equals_m3541721061(L_2, _stringLiteral2914064246, /*hidden argument*/NULL);
		if (!L_3)
		{
			goto IL_0047;
		}
...
IL_0047:
	{
		...
		NullCheck(L_6);
		bool L_7 = String_Equals_m3541721061(L_6, _stringLiteral145572359, /*hidden argument*/NULL);
		if (!L_7)
		{
			goto IL_0079;
		}
...
IL_0079:
	{
		...
		NullCheck(L_10);
		bool L_11 = String_Equals_m3541721061(L_10, _stringLiteral221407536, /*hidden argument*/NULL);
		if (!L_11)
		{
			goto IL_00a6;
		}
...
extern Il2CppCodeGenString* _stringLiteral2914064246;
extern Il2CppCodeGenString* _stringLiteral114238575;
extern Il2CppCodeGenString* _stringLiteral145572359;
extern Il2CppCodeGenString* _stringLiteral418853336;
extern Il2CppCodeGenString* _stringLiteral221407536;
extern Il2CppCodeGenString* _stringLiteral3055494373;
...
extern "C"  void Main_OnAdClosed_m2659309234 (Main_t2390489 * __this, String_t* ___target, const MethodInfo* method)
{
	...
	}
	{
		String_t* L_0 = ___target;
		NullCheck(L_0);
		bool L_1 = String_Equals_m3541721061(L_0, _stringLiteral2914064246, /*hidden argument*/NULL);
		if (!L_1)
		{
			goto IL_0027;
		}
	...
	{
		__this->set_ViewButton_7(_stringLiteral114238575);
		__this->set_viewFail_11((bool)1);
		goto IL_0070;
	}
...
IL_0027:
	{
		String_t* L_2 = ___target;
		NullCheck(L_2);
		bool L_3 = String_Equals_m3541721061(L_2, _stringLiteral145572359, /*hidden argument*/NULL);
		if (!L_3)
		{
			goto IL_004e;
		}
	...
	{
		__this->set_FlexButton_8(_stringLiteral418853336);
		__this->set_flexFail_13((bool)1);
		goto IL_0070;
	}
...
IL_004e:
	{
		...
		NullCheck(L_4);
		bool L_5 = String_Equals_m3541721061(L_4, _stringLiteral221407536, /*hidden argument*/NULL);
		if (!L_5)
		{
			goto IL_0070;
		}
	...
	{
		__this->set_RewardButton_9(_stringLiteral3055494373);
		__this->set_rewardFail_15((bool)1);
	}
